...
Use `$typescript-style` with this skill.
...
Read:
- [directory structure](references/directory-structure.md) for small-project and module-first layouts, file granularity, and growth rules.
