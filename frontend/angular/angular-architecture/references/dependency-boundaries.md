...
```text
jobs/features/discovery
  ✗→ jobs/features/detail/internal-component
```
...
`libs/shared/` must remain domain-neutral.
...
The deployable app may compose feature entry points, root routes, providers, application configuration, and global styling. Keep business behavior, feature state, feature data access, and feature-specific components out of the app shell.
