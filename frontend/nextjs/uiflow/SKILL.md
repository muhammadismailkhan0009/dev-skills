...
In consuming applications, use the installed package version and its bundled `code_generation_guidelines/uiflow_llm_guidelines.md` as authority for runtime/API details when available. Do not assume the newest upstream source matches the installed package version.
