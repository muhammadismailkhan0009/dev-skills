...
Do not create UIFlow-specific tests for interactions that should not be UIFlow flows in the first place. Simple local React state should stay covered by the component's ordinary behavior tests.
